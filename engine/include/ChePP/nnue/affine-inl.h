...
namespace chepp::nnue::layers::affine {
    namespace HWY_NAMESPACE {
        ...
        struct Layer<Kernels::Scalar, P> {
            ...
            using weight_array_t   = mdarray<const input_type, weights_extent_t, hwy::AlignedVector<input_type>>;
            using bias_array_t     = mdarray<const output_type, biases_extent_t, hwy::AlignedVector<output_type>>;
