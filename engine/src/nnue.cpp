...
namespace chepp::nnue {
    ...
    Arch::register_kernels() {
        registry.register_kernel<accum_t, HWY_STATIC_TARGET, 0>();
        ...
        registry.register_kernel<psqt_t, HWY_STATIC_TARGET, 0>();

        registry.register_kernel<act0_t, HWY_STATIC_TARGET, 0>();
        ...
        registry.register_kernel<l1_t, HWY_STATIC_TARGET, 0>();
        ...
        registry.register_kernel<act1_t, HWY_STATIC_TARGET, 0>();
        ...
        registry.register_kernel<l2_t, HWY_STATIC_TARGET, 0>();
        registry.register_kernel<act2_t, HWY_STATIC_TARGET, 0>();
        registry.register_kernel<l3_t, HWY_STATIC_TARGET, 0>();
    }
} // namespace chepp::nnue
// HWY_TEST_MAIN();
#endif // HWY_ONCE